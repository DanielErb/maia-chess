...
class LC0Engine(TourneyEngine):
    def __init__(self, weightsPath = None, nodes = None, movetime = _movetime, isHai = True, lc0Path = None, threads = 1, backend = 'cuda-auto', backend_opts = '', name = None, engine = None, noise = False, extra_flags = None, verbose = False, temperature = 0, temp_decay = 0):
